...
PUTN PROC NEAR   ;AX'I 10LUK TABANDA EKRANA YAZDIRIR (Prints the AX register in decimal form)
    PUSH CX
    PUSH DX
    XOR DX,DX
    PUSH DX
...
QUICKSORT PROC NEAR ; DIZIYI SIRALAMA ISLEMI YAPILIYOR (Sorting the Array)
    CMP CX,DX
    JGE QSB
    MOV BX,CX
    MOV SI,CX
